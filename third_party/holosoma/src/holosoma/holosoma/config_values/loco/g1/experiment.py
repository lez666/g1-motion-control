...
g1_29dof_robust = ExperimentConfig(
    env_class="holosoma.envs.locomotion.locomotion_manager.LeggedRobotLocomotionManager",
    training=TrainingConfig(project="hv-g1-manager", name="g1_29dof_robust_manager"),
    algo=replace(algo.ppo, config=replace(algo.ppo.config, num_learning_iterations=25000, use_symmetry=True)),
    simulator=simulator.isaacgym,
    robot=robot.g1_29dof,
    terrain=terrain.terrain_locomotion_mix,
    observation=observation.g1_29dof_loco_single_wolinvel_robust,
    action=action.g1_29dof_joint_pos,
    termination=termination.g1_29dof_termination_robust,
    randomization=randomization.g1_29dof_randomization_robust,
    command=command.g1_29dof_command_robust,
    curriculum=curriculum.g1_29dof_curriculum_robust,  # Use robust curriculum with easier initial learning
    reward=reward.g1_29dof_loco_robust,
    nightly=NightlyConfig(
        iterations=5000,
        metrics={"Episode/rew_tracking_ang_vel": [0.7, "inf"], "Episode/rew_tracking_lin_vel": [0.55, "inf"]},
    ),
...
__all__ = ["g1_29dof", "g1_29dof_fast_sac", "g1_29dof_robust"]
