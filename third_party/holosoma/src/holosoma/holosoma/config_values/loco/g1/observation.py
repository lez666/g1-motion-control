...
g1_29dof_loco_single_wolinvel_robust = ObservationManagerCfg(
    groups={
        "actor_obs": ObsGroupCfg(
            concatenate=True,
            enable_noise=True,
            ...
            terms={
                ...
                "projected_gravity": ObsTermCfg(
                    func="holosoma.managers.observation.terms.locomotion:projected_gravity",
                    scale=1.0,
                    noise=0.05,  # Adjusted to match prompt file requirement
                ),
                "command_lin_vel": ObsTermCfg(
                    func="holosoma.managers.observation.terms.locomotion:command_lin_vel",
                    scale=1.0,
                ...
                "dof_pos": ObsTermCfg(
                    func="holosoma.managers.observation.terms.locomotion:dof_pos",
                    scale=1.0,
                    noise=0.01,  # Matches prompt file requirement
                ),
                "dof_vel": ObsTermCfg(
                    func="holosoma.managers.observation.terms.locomotion:dof_vel",
                    scale=0.05,
                    noise=1.5,  # Adjusted to match prompt file requirement (was 0.1)
                ),
                "actions": ObsTermCfg(
                    func="holosoma.managers.observation.terms.locomotion:actions",
                    scale=1.0,
        ...
        "critic_obs": ObsGroupCfg(
            concatenate=True,
            enable_noise=False,  # Critic observations have no noise (matches prompt file)
            history_length=1,
            terms={
                "base_lin_vel": ObsTermCfg(
                    func="holosoma.managers.observation.terms.locomotion:base_lin_vel",
...
__all__ = ["g1_29dof_loco_single_wolinvel", "g1_29dof_loco_single_wolinvel_robust"]
