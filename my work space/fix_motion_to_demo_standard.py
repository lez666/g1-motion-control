...
def fix_motion_to_demo_standard(input_file, output_file, reference_demo_file=None):
    ...
    if reference_demo_file is None:
        reference_demo_file = "/home/wasabi/g1-motion-control/third_party/holosoma/src/holosoma/holosoma/data/motions/g1_29dof/whole_body_tracking/sub3_largebox_003_mj.npz"
